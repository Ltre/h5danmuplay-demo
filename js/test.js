(function () {
    ...
    function qa(a) {
        ...
        var f, d, g = Array(80), h = 1732584193, p = 4023233417, k = 2562383102, l = 271733878, m = 3285377520, o, n, t, q, r, a = function (a) {
            for (var a = a.replace(/\r\n/g, "\n"), c = "", b = 0; b < a.length; b++) {
    ...
    S.prototype = {
        addEventListener: function (a, c) {
            ...
            this._hasResp = !0;
            null != a.error || 1 != a.status ? this.dispatch({type: PartnerConstant.OPEN_API_ERROR}) : this.dispatch({
    ...
    k.cache = function () {
        A[k._vid] = {};
        A[k._vid][k._type] = {v: this._v, videoInfo: this._videoInfo}
    };
    ...
    k.total = function (a) {
        for (var c in a.segs) {
            for (var b = 0, f = 0, d = 0; d < a.segs[c].length; d++)var g = a.segs[c][d], b = b + parseInt(g.seconds), f = f + parseInt(g.size);
    ...
    k.init = function (a) {
        ...
        if (!a.ep || !a.ip)d.sendErrorReport(2004), d.showError(null, "\u6570\u636e\u89e3\u6790\u9519\u8bef");
            ...
            if (2 > c.split("_").length)d.sendErrorReport(2004), d.showError(null, "\u6570\u636e\u89e3\u6790\u9519\u8bef"); else {
                d.userCache.sid = c.split("_")[0];
                d.userCache.token = c.split("_")[1];
                if (null != a.error_code) {
                    if (-6 == a.error_code || -7 == a.error_code)d.sendErrorReport(4E3); else {
                        if (-28 == a.error_code) {
                ...
                b.defaultVideoType), this._videoInfo.src = k.m3u8src(b.defaultVideoType), this.cache(), null == this._callback ? d.GetM3U8OK(this._v, this._videoInfo) : this._callback(this._v, this._videoInfo); else if ("mp4" == this._type) {
                    c = ["3gphd", "mp4", "flv"];
                    m = null;
                    for (var e = 0; e < c.length; e++)if (this._videoInfo._videoSegsDic[c[e]] && !("3gphd" == c[e] && 7200 < parseInt(a.seconds))) {
                        m = c[e];
                        break
                    }
    ...
    T.prototype = {
        getFileId: function (a, c, b, f) {
            ...
            var h = {flv: 0, flvhd: 0, mp4: 1, hd2: 2, "3gphd": 1, "3gp": 0}[e], p = {
                flv: "flv",
                mp4: "mp4",
                hd2: "flv",
                "3gphd": "mp4",
    ...
    V.prototype = {
        resize: function (a, c) {
            ...
            if (d.isNeedFrontAd)this._oplayer.controls.onVideoBtnTouchEnd(); else this._oplayer.controls.onVideoBtnClick()
        },
        pauseVideo: function () {
            this._player.pause()
        }, seekTo: function (a) {
    ...
    (function () {
        ...
        for (var i in b)if (-1 !== navigator.userAgent.indexOf(b[i]) ? (d[i] = !0, d.os += b[i] + " ") : d[i] = !1, -1 !== navigator.userAgent.indexOf("Android"))a = navigator.userAgent.indexOf("Android"), a = navigator.userAgent.substr(a, 10), a > b.isAndroid4 && (d.isAndroid4 = !0, d.os += a + " ");
        ...
        try {
            ...
            } else if (navigator.plugins && 0 < navigator.plugins.length && (g = navigator.plugins["Shockwave Flash"]))for (var b = 1, h = g.description.split(" "), g = 0; g < h.length; ++g)isNaN(parseInt(h[g])) || parseInt(h[g])
        } catch (p) {
            i = b = 1
        }
        d.isSupportFlash =
    ...
    J.prototype = {
        ...
        isSupportFlash: function () {
            ...
            if (this._events &&
                ...
                }, 500); else"flash" == d.playerType && (c = setInterval(function () {
                    if (1 == C.swfLoaded) {
                        d.playerCurrentState = d.playerState.PLAYER_STATE_READY;
                        debug.log(d.playerCurrentState);
                        clearInterval(c);
            ...
            d.playerType = "h5";
            var a = "http://v.youku.com/player/getM3U8/vid/" + this._vid + "/type/mp4/ts/" + parseInt((new Date).getTime() / 1E3), a = a + (this._password ? "/password/" + this._password : ""), a = '<video src="' + (a + "/v.m3u8") + '" controls width=' + this._width + " height=" + this._height + " id=" + this._id + " autohide=false " + (this._poster ? "poster=" + this._poster : "") + " " + (!0 == this._autoplay ?
                    "autoplay=true" : "") + "></video>";
    ...
    (function () {
        ...
        var a = {
            ...
            return function (c) {
                if (a[c])return a[c];
                var b = c.split("-"), e = b[0];
                if (1 < b.length)for (var d = 1, k = b.length; d < k; d++)e += b[d].charAt(0).toUpperCase() + b[d].substring(1);
                return a[c] = e
            }
        }(), b = function () {
    ...
    FX.transitions.elasticOut = function (a, b, e, f, d, g) {
        ...
        if (1 == (a /= f))return b + e;
        g || (g = 0.3 * f);
        if (!d || d < Math.abs(e))var d = e, h = g / 4; else h = g / (2 * Math.PI) * Math.asin(e / d);
        return d * Math.pow(2,
                -10 * a) * Math.sin((a * f - h) * 2 * Math.PI / g) + e + b
    };
    ...
    $.prototype = {
        addEventListener: function (a, b) {
            ...
            b.defaultLanguage = e;
            a = this._nodes;
            for (e = 0; e < a.length; e++)if (a[e].getAttribute("data-vid") == c) {
    ...
    da.prototype = {
        addEventListener: function (a, b) {
            ...
            for (var a = ["<button class=x-control-btn>",
                "", "</button>"], b = ['<div class=x-panel style="display:none"><ul>', "", "</ul><div class=x-mask></div>", "</div>"], e = "", f = [], d = ["2", "1.5", "1", "0.8"], g = 0; g < d.length; g++) {
                var h = d[g], p = "", k = "";
            ...
            var b = this.panel;
            -1 === this.playRate.className.indexOf("pressed") ?
                (this.playRate.className += " pressed", b.style.display = "block", this.player._reporter.sendUserActionReport("xcra", "c"), this.dispatch({type: "settingshow"})) : (this.hide(), this.player._reporter.sendUserActionReport("xhra", "c"));
            this.dispatch(a)
            ...
            for (var b = this.button, e = this.nodes, f = 0; f < e.length; f++)if (e[f].getAttribute("data-vtype") ==
                a) {
    ...
    ea.prototype = {
        addEventListener: function (a, b) {
            ...
            this._currentTime = a;
            this.setProgress(Math.min(Math.max(this._currentTime, 0), b.videoInfo.totalTime),
                !0);
            return !1
    ...
    ha.prototype = {
        addEventListener: function (a, b) {
            ...
            var a = a.data[0], c = ["<button class=x-control-btn title=\u753b\u8d28\u8bbe\u7f6e>", "", "</button>"], e = ['<div class=x-panel style="display:none"><ul>',
                "", "</ul><div class=x-mask></div>", "</div>"], f = "", d = [], g;
            for (g in u)if (-1 !== a.streamtypes.indexOf(g) && -1 === d.indexOf(u[g])) {
                var h = "", k = "";
            ...
            var b = this._panel;
            -1 === this._quality.className.indexOf("pressed") ?
                (this._quality.className += " pressed", b.style.display = "block", this.player._reporter.sendUserActionReport("xcq", "c"), this.dispatch({type: "settingshow"})) : (this.hide(), this.player._reporter.sendUserActionReport("xhq", "c"));
            this.dispatch(a)
        }, switchQuality: function (a) {
            this.player._reporter.sendUserActionReport("xsq", "c");
            a.stopPropagation();
            for (var c = a.target, a = null, a = c.getAttribute ? c.getAttribute("data-vtype") : c.parentNode.getAttribute("data-vtype"), c = this._button, e = this._nodes, f = 0; f < e.length; f++)if (e[f].getAttribute("data-vtype") ==
                a) {
                if (-1 !== e[f].className.indexOf("selected")) {
            ...
            a.stopPropagation();
            for (var a = a.target.dataset.vtype, b = this._button, e = this._nodes, f = 0; f < e.length; f++)if (e[f].dataset.vtype == a) {
                if (-1 !== e[f].className.indexOf("selected")) {
                    this.toggleQualityPanel();
                    return
                }
    ...
    ia.prototype = {
        bindDynamicEvent: function () {
            ...
            for (var f = Math.floor((this._panel.offsetWidth - 60 + 16) / 166) * Math.floor((this._panel.offsetHeight - 120 + 12) / 97), f = (f > c ? c : f) - 1, f = 0 > f ? 0 : f, c = 0; c < f; c++) {
                var d = a[c].picUrl, g = a[c].title.substr(0, 20), h = "http://v.youku.com/v_show/id_" + a[c].codeId + ".html?from=", k = "y7", k = "interior" == b.config.winType ? k + ".2-1-" : k + ".7-1-", k = k + b.v.data[0].categories, k = k + ".4", k = k + ("." + (c + 1) +
                    "-1"), k = k + ("." + this._apt + "-" + this._pg + "-" + this._md + "-" + c), h = h + k;
                debug.log(h);
        ...
        init: function (a) {
            ...
            if (!(null == c || 0 == c.length)) {
                for (var e = ["<ul class=x-showlist-bullet>", "", "</ul>"], f = [], d = 0; d < c.length; d++) {
                    var g =
                        c[d], h = "http://v.youku.com/v_show/id_" + g.vidEncoded + ".html";
    ...
    L.prototype = {
        sendRecommendLog: function (a) {
            ...
            if (61 == a)clearTimeout(this.tstimer), this.tstimer = null; else if (e.player.video.paused)return;
        ...
        getPlayByType_: function (a) {
            ...
            for (var e in a)if (-1 !== c.indexOf(e))return a[e];
            return 0
            ...
            for (var c = a.t, e = !1, f = ""; !e;) {
                for (var f = "", i = 0; 20 > i; i++)var g = Math.floor(61 * Math.random()), f = f + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXTZabcdefghiklmnopqrstuvwxyz".substring(g,
                        g + 1);
                hstr = c + f;
                hashcash = qa(hstr);
            ...
            c.x = E(n(f));
            i = n(c);
            if ("xre" == a)this.checkPlayerResize("http://e.stat.ykimg.com/red/ytes.php?", i); else {
                if ("xenfs" == a || "xexfs" == a) {
                    this._giveupReTag = !0;
                    var g = this;
                    setTimeout(function () {
            ...
            if (!0 === this._giveupReTag)debug.log("give up xre after enfs or exfs"); else {
                ...
                this._resizeList.push({str: b, time: (new Date).getTime(), w: e.offsetWidth, h: e.offsetHeight});
                var f = this;
                setTimeout(function () {
                    if (0 !=
                        f._resizeList.length) {
                        for (var b = f._resizeList[0].time, c = 0; c < f._resizeList.length; c++) {
                            var e = f._resizeList[c].w, k = f._resizeList[c].h, l = f._resizeList[c].time;
            ...
            if (!this._hasComScore) {
                for (var c = document.getElementsByTagName("script"),
                         e = 0; e < c.length; e++)if (-1 !== c[e].src.indexOf("scorecardresearch.com/beacon.js")) {
                    this._hasComScore = !0;
                    break
                }
            ...
            if (!(null == this._adinfo || null == this._adinfo.VAL || 0 == this._adinfo.VAL.length)) {
                for (var a = {
                    ...
                    if (!(null == d.VID || null == d.VQT)) {
                        null == d.SU && (d.SU = []);
                        null == d.SUE && (d.SUE = []);
                        if (0 == e)a.SUS = d.SUS || []; else for (var i = 0; i < d.SUS.length; i++)a.SU.push({
                            T: b,
                            U: d.SUS[i].U
                        });
                        for (i = 0; i < d.SU.length; i++) {
                            var g = d.SU[i].T + b;
                            a.SU.push({T: g, U: d.SU[i].U})
                        }
                        if (e == this._adinfo.VAL.length - 1)a.SUE = d.SUE; else for (i = 0; i < d.SUE.length; i++)g = b + d.AL, a.SU.push({
                            T: g,
                            U: d.SUE[i].U
                        });
                        b += d.AL;
                        a.CU.push({T: b, U: d.CU});
                        a.CUM.push({T: b, CUM: d.CUM});
                        1 == parseInt(d.VT) && a.VTVC.push({U: d.VC, T: b});
                        if (0 != this._vt2nodes.length)for (i = 0; i < this._vt2nodes.length; i++)d = this._vt2nodes[i].VC, g = this._vt2nodes[i].pos_, -1 == g && a.VTVC.push({
                            U: d,
                            T: 0
                        }), g == e && a.VTVC.push({U: d, T: b})
                    }
                }
                a.AL = b;
                a.RS = this.buildAdRS();
    ...
    M.prototype = {
        ...
        onAdSuspend: function () {
            ...
            this._adfirsttu || (this._adfirsttu = !0, this._adreporter.sendSUS(), this._adreporter.sendVC(), this._adplugin.reportTime("advideo"), d.isNeedAdrTrick() && d.adrInvalidPauseCheck(this.video), 0 === this._adplugin.SKIP && this.dispatch({type: ADConstant.UGLY_CLOSE_AD_HINT}))
    ...
    N.prototype = {
        init: function (a) {
            ...
            if (null == a || null == a.VAL || 0 == a.VAL.length)a = {VAL: []}, this.dispatch({
                type: ADConstant.FRONT_AD_UNITED_INFO_OK,
                data: {info: {VAL: []}, vtvc: this._vtvc || []}
            }); else {
                var a = new ma(a, this._vtvc), b = this;
            ...
            this.reportTime("adinfo");
            this._isAdInfoOk = !0;
            if (a && a.VAL)for (var a = this.splitVTVC(a), b = a.VAL, e = 0; e < b.length; e++)this._adsrcs.push(b[e].RS), this._adsecs.push(parseInt(b[e].AL));
            ...
            null == a || null == a.VAL || 0 == a.VAL.length || 10 != a.P ? this.dispatch({type: ADConstant.PAUSE_AD_INFO_ERROR}) : (debug.log("<b>pause ad len = " + a.VAL.length + "</b>"), this.dispatch({
    ...
    H.prototype = {
        sendSUS: function () {
            ...
            if (!("undefined" == typeof b || 0 === b.length))for (var e = 0; e < b.length; e++)if (a < parseInt(b[e].T)) {
    ...
    na.prototype = {
        ...
        clearTimer: function () {
            ...
            if (this.video.currentTime > this._addata.VAL[0].AL)this.onAdEnded(); else b.hide(this.controls.buttons.loading), this._adBegin = !0, b.hide(this.controls.buttons.loading), this._adplugin.setLeftSecond(this.leftSecond()),
                this._adreporter.sendSU(this.video.currentTime), this._adreporter.sendUnitedVTVC(this.video.currentTime), this._adfirsttu || (this._adplugin.show(), this._adreporter.sendSUS(), this._adfirsttu = !0, this._adplugin.reportTime("advideo"), 0 === this._adplugin.SKIP && this.dispatch({type: ADConstant.UGLY_CLOSE_AD_HINT}))
        }, onAdLoadedMetaData: function () {
            this._adBegin = !0
        }, onAdClick: function () {
            this.video.pause();
    ...
    oa.prototype = {
        ...
        bindDynamicEvent: function () {
            ...
            var a = this._payPanel, b = this._informationPanel, e = this.miniProgressBar, d = this.interactionPanel, i = this._languagePanel;
        ...
        onWaiting: function () {
            ...
            if (1 < a.targetTouches.length)this.interactionPanel.hide(); else {
                ...
                var b = Math.abs(this._smx - this._sx), e =
                    Math.abs(this._smy - this._sy), d = this._smt - this._sactionTime;
                0 === this._stmlrtag && (this._stmlrtag = b > e ? 1 : -1);
                1 == this._stmlrtag && a.preventDefault();
                if (1 != this._sactionType)if (100 < b && b > e && 500 > d)debug.log("quick seek moving"), this.player.video.pause(), this._sactionType = 1, d = this._smx > this._sx ? 30 : -30, this.interactionPanel.setTip(this._stime, d), this.interactionPanel.show(); else if (200 > b && (100 > e && 1E3 < d) && (this._spretag = !0), this._spretag && b > e || this._stmtag)debug.log("stmtag =" + this._stmtag), this._sactionType =
        ...
        hideShowListBtn: function () {
            ...
            var c = q(b.config.parentBox).offsetWidth, e = q(b.config.parentBox).offsetHeight;
    ...
    O.prototype = {
        ...
        onEndedIPH: function () {
            ...
            if (!(this.isOnePiece() && !0 == this.controls.checkPlayLimit()))if (this.isOnePiece() || s == b.videoInfo._videoSegsDic[m].length - 1)w = !0, this._reporter.addPlayerDurationReport(61), this._reporter.sendTSLog(61), this.clearLocalPlayPoint(), this.showEndCard(a), l.appendItem("phase", "videoended");
            ...
            if (!b.v.data[0].error_code && !b.v.data[0].error)if ("directsrc" == b.config.playType && !1 == b.isWeixin)b.addEventHandler(this.video, "play", b.bindAsEventListener(this, this.onPlayIPH)), b.addEventHandler(this.video, "timeupdate", b.bindAsEventListener(this, this.onTimeUpdateIPH)), b.addEventHandler(this.video, "ended", b.bindAsEventListener(this, this.onEndedIPH)), b.addEventHandler(this.video, "webkitendfullscreen",
                b.bindAsEventListener(this, this.onEndFullscreen)); else {
                var a = {
    ...
    var s = -1, w = !1, m = null, fa = 0, ga = 600, u = {
        flvhd: "\u6807\u6e05",
        flv: "\u6807\u6e05",
        mp4: "\u9ad8\u6e05",
        hd2: "\u8d85\u6e05"
    ...
    b.getUCStr = function (a) {
        var c = "";
        if ("undefined" != typeof getUCSecret)a = getUCSecret(a), c += "&xk=" + a; else if ("undefined" != typeof uckey)var e = uckey.getUCKey(a), c = c + ("&vid=" + a + "&uc_param_str=xk&xk=" + e); else!0 == b.isUCBrowserAndValidVersion() && (c += "&vid=" + a + "&uc_param_str=xk");
        return c
    };
    ...
    YoukuHTML5Player = function (a, c) {
        ...
        b.config = a;
        var e = q(b.config.parentBox), d = parseInt(b.config.width);
    ...
    b.extend(YoukuHTML5Player.prototype, {
        ...
        multiSeekTo: function (a) {
            ...
            if (!d.isIOS) {
                ...
                setTimeout(function () {
                    if (1 === a)e.style.width = "100%", e.style.height = "100%", e.style.top = null, e.style.left = null; else {
                        var c = b.get(".x-player"),
                            c = c.offsetWidth / c.offsetHeight, d = e.videoWidth / e.videoHeight;
